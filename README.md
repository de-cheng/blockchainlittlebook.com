...
通过访问 decheng.xyz，你正在阅读的《区块链小白书》是经过德成 "Fork" 的版本，就是在保留原著全部内容的基础上，加入了德成的一些见解，并丰富了一些内容。
...
***
陈德成补充：  
德成使用 Mixin messenger 已经有4个多月了，我们一般把 Mixin messenger 简称为 Mixin，很有意思的是，Mixin 本来只有聊天功能和钱包功能，但是基于 Mixin 可以开发出能实现各种功能的“机器人”（类似微信上的小程序）。前面李笑来介绍的两万多人的群，就是一种“机器人”。德成在 Mixin 上运营了一个“社群”，就是通过“机器人”实现的，其部分功能有点像微信上的公众号，但又可以实现群聊，不过一般只会在讲师做完语音直播分享后，才会开启短暂的群聊，而平时就是像公众号一样为大家提供各种服务，目前，除语音分享外平时的服务包括：

1.每天“直播”德成通过 “Lucky BtC Bot” 机器人做任务签到赚BTC。
> “Lucky BTC Bot”(Mixin ID：7000101487), 是由 Mixin 团队运营的一个能让用户免费获得BTC的机器人。团队承诺活动永久有效，规则就是需要完成一定的任务并签到，第一天领取100聪（0.000001BTC），如果连续每天在8:00到第二天的8:00之前完成任务并签到（北京时间8:00），每次领取的BTC将比前一天递增100聪，可别小看这每天递增的100聪，5年后，将总共领取1.666BTC，按目前BTC价格计算，价值约20万元人民币。
