...
[李笑来](http://lixiaolai.com)（原著）&copy; 2019 / [陈德成](https://decheng.site)（fork）&copy; 2019

-----

陈德成补充:

通过访问 blockchainbook.top，你正在阅读的《区块链小白书》是经过德成 "Fork" 的版本，就是在保留原著全部内容的基础上，加入了德成的一些见解，并丰富了一些内容，以“陈德成补充：”标识，以下一个分割线截止。你先阅读完《区块链小白书》的内容，篇幅不长，文末有介绍fork方法。
...
***
陈德成补充：  
德成使用 Mixin messenger 已经有4个多月了，我们一般把 Mixin messenger 简称为 Mixin，很有意思的是，Mixin 本来只有聊天功能和钱包功能，但是基于 Mixin 可以开发出能实现各种功能的“机器人”（类似微信上的小程序）。前面李笑来介绍的两万多人的群，就是一种“机器人”。德成在 Mixin 上运营了一个“社群”，就是通过“机器人”实现的，其部分功能有点像微信上的公众号，但又可以实现群聊，不过一般只会在讲师做完语音直播分享后，才会开启短暂的群聊，而平时就是像公众号一样为大家提供各种服务，具体的服务介绍，后面还会有详细介绍。
***
