...
通过访问 blockchainbook.top，你正在阅读的《区块链小白书》是经过德成 "Fork" 的版本，就是在保留原著全部内容的基础上，加入了德成的一些见解，并丰富了一些内容，用“陈德成补充：”标识，以下一个分割线截止。
...
在 [Mixin Messenger](https://mixin.one/messenger) 上，有一个群，群号是 *7000102093*，里面有两万多人 —— 可能是目前国内最优质的小白社群。群里定期有公开课，并且定期会开放聊天机会…… 在那里，你可以向别人提问，也可以观察他人之间的讨论，很多你弄不明白的问题，可能一不小心就彻底被他人的对话解决掉了。

***
陈德成补充：  

德成使用 Mixin messenger 已经有4个多月了，很有意思的是，Mixin Messenger 本来只有聊天功能和钱包功能，但是基于 Mixin 可以开发出能实现各种功能的“机器人”（类似微信上的小程序）。前面李笑来介绍的两万多人的群，就是一种“机器人”。

德成在 Mixin 上运营了一个“社群”（Mixin ID：**7000102478**），就是通过“机器人”实现的，其部分功能有点像微信上的公众号，但又可以实现群聊，不过一般只会在讲师做完分享后或有别的讨论需要，才会开启短暂的群聊，而平时就像公众号一样为大家提供各种服务。[点击这里](https://docs.google.com/spreadsheets/d/1Wv5e6zLP8rBPSeZDNSN2ZUKt1nMjlIIbz7DQaEK428E/edit?usp=sharing)可以查看用户数量的变化数据。
***
...
本文有反复提及的《定投改变命运》是真可以改变普通人命运的一本书，德成强烈建议你反复地仔细阅读。不仅要仔细阅读，深入理解定投策略的“妙处”，还要有行动，做到才算数。

所以最好读完后付费加入能让你**真正做到**定投策略的实践群“定投践行群”，付费不仅是购买了“入群门票”，同时也购买了“笑来定投课堂”以及其他各种“提升赚钱能力等级”的课程内容。具体详情可查看“[为什么普通人错过“定投践行群”的损失可能无限大？](https://decheng.xyz/#/boxgroup/)”。
...
注册域名成本最少只需要十几元，德成也是第一次注册域名，如果你有兴趣爱折腾可以尝试，过程中如果遇到问题，可以找德成帮忙，但德成精力有限（现在开始在建设自己的独立域名网页），所以德成建了收费的“有事儿找德成”机器人：Mixin ID: 7000102622，德成会优先帮助付费加入的朋友解决问题，现在费用很便宜，年费0.6BOX，只是交个朋友，钱多钱少不重要，如果后面加入人数多了再考虑上调。
***

区块链小白书，原著链接：<https://blockchainlittlebook.com>
