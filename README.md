...
德成使用 Mixin messenger 已经有4个多月了，我们有时会把 Mixin messenger 简称为 Mixin，很有意思的是，Mixin 本来只有聊天功能和钱包功能，但是基于 Mixin 可以开发出能实现各种功能的“机器人”（类似微信上的小程序）。前面李笑来介绍的两万多人的群，就是一种“机器人”。德成在 Mixin 上运营了一个“社群”，就是通过“机器人”实现的，其部分功能有点像微信上的公众号，但又可以实现群聊，不过一般只会在讲师做完分享后或有别的讨论需要，才会开启短暂的群聊，而平时就像公众号一样为大家提供各种服务。
***
