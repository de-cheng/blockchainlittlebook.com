...
> “Lucky BTC Bot”(Mixin ID：7000101487), 是由 Mixin 团队运营的一个让用户能免费获得BTC的机器人，承诺活动永久有效，规则就是需要完成一定的任务并签到，第一天领取100聪（0.000001BTC），如果连续每天在8:00到第二天的8:00之前完成任务并签到，每次领取的BTC将比前一天递增100聪，可别小看这每天递增的100聪，5年后，将总共领取1.666BTC，按目前BTC价格计算，价值约20万元人民币。
