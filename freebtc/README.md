...
从这个角度望过去，普通人买比特币，更像是购买比特币这家世界银行的股票。如果你能理解 BTC 其实是 Bitcoin 的股票，那么，对你来说，很可能最佳策略是 **“买入之后长期持有”** —— 仔细想想看吧，到底是不是这样？有没有更好的投资标的呢？遇到值得投资的标的又应该采用什么样的投资策略呢？请移步[《定投改变命运》（开源第三版）](https://onregularinvesting.com) —— 请认真阅读，这本书能够改变的不止是你一个人的命运，被改变的，很可能是你的家族。（关于《定投改变命运》书尾提到的“区块链教育产品”的门票，可以加德成微信号：cdckql ，德成可以提供门票及全套指导与帮助。定投策略是我们在进行股票或区块链数字资产投资时，最正确且最应该采取的策略，甚至我们学习很多技能，也适合用采用定投策略，很可惜很多人并不懂定投策略的“奥义”，德成真心推荐你反复阅读[《定投改变命运》（开源第三版）](https://onregularinvesting.com)）
...
首先你是 Mixin Messenger 的新用户，或者说 Lucky BTC Bot 的新用户，为了能随时找到你，最好先添加德成的微信：cdckql，备注“领BTC红包”，然后在 Mixin messenger 上搜索德成的 Mixin ID：37163725，就可以找到德成，给德成发送消息“领BTC红包”，通过“签到助手”机器人审核证实你是新用户后，德成就会拉你到红包群。

你会在这个群里收到BTC红包 —— 很可能是你人生的第一笔免费比特币！

注意，福利还没完，除了上面的红包之外，如果你完成 2.5.1 介绍的签到领 BTC 连续7天，还将获得5000聪(0.00005BTC)的奖励，可别小看这5000聪现在只值3元人民币，将来可能也是一小笔钱呢。
...
> * 2019年12月21日之前注册的有效用户（德成就属于这部分用户），每次领取的BTC会比前一天递增100聪，也就是额外的“加速福利”，可别小看这每天递增的100聪，5年后，将总共领取1.666BTC，按目前BTC价格50000人民币计算，价值约20万元人民币。前提是完成随机任务，并签到不间断，未完成任务会暂停加速或从100聪重新开始，签到中断会从100聪重新开始。
> * 2019年12月21日之后注册的新用户每天可领取100聪（0.000001BTC），目前尚不清楚今后会不会再次开放“加速福利”。你现在注册自然是没有递增奖励了，但你可以与德成合作获得“递增BTC”的分红，后面有详细介绍。
...
本文在第一部分介绍了BTC对于普通人的意义，还推荐了进入比特币世界**最正确的、最安全的、最应该采取的策略：定投策略**，不信你就去看看[《定投改变命运》（开源第三版）](https://onregularinvesting.com)（不过现在别点进去看，先往下看完，以后慢慢看）。

不用担心害了朋友，他们听说的谁谁炒比特币倾家荡产了、跳楼了，那都是因为那些人采用了错误的策略，结局自然不会好)

所以，复制以下文字及链接，发给朋友

> 《为什么你要拥有BTC(比特币)？如何获取你人生的第一笔免费的BTC？》https://blockchainbook.top/freebtc/#/

让你的朋友按照本文介绍的方法领取德成的BTC红包(领取德成的红包好处之一是不用你自己花BTC发红包)，你朋友完成连续7天签到领BTC后，你和你的朋友将分别获得5000聪比特币。此外，你和你的朋友都可以留在分红群里。

重点来了，德成会在分红群每周拿出当周德成领取的递增BTC总额的20%来分红(暂定20%，以后只会往高调)。

+ 其中10%直接发到分红群里，由群里所有成员瓜分。

+ 另外10%将按照推荐人数按比例瓜分，这部分是直接发到个人的。

请注意，德成本人邀请的人数不参与瓜分这10%，也就是说，假如只有你推荐了新人(即使是一个)你将分得10%，目前（2019年1月）一周领约50000聪（0.0005BTC，以后只会越来越多），除了参与领群里的5000聪红包，你还将获得5000聪。
...
## 4. 居然还有白捡的BTC
在京东、淘宝、拼多多购物之前，使用ExinEarn:7000000014，“转链”后下单购买，就可以返佣BTC。还有免费专区，首单全额补贴，相当于免费领一件商品。 这也是由 Exin 团队打造的非常实用的机器人应用。
