...
在 Mixin messenger 上搜索 37163725，你就可以找到德成，给德成发送消息“红包群”，德成就会拉你到红包群。

你会在这个群里收到红包 —— 很可能是你人生的第一笔比特币！


### 2.5 挑战签到任务领取更多 BTC
 “Lucky BTC Bot”(Mixin ID：7000101487), 是由 Mixin 团队运营的一个能让用户免费获得BTC的机器人。
...
> * 2019年12月21日之后注册的新用户每天可领取100聪（0.000001BTC），目前尚不清楚今后会不会再次开放“加速福利”。
...
这个由德成运营的机器人名称是“签到赚1.6BTC”，群号是 **7000102478**
...
### 4.1 首先跟新人朋友创建群组，把Lucky BTC Bot(7000101487)机器人也加入群组中。

### 4.2 点击群组聊天框的加号（+）创建并发送红包, 最少 0.0002 BTC（价值约10元人民币）。
...
### 4.3 当有效的新人用户抢了你的红包，并完成一次签到赚BTC，新人红包任务就算完成了。新人连续签到 7 天后，你还会收到 0.0001 BTC 的奖励。 
> 所以只要有两个新人连续签到7天，你就回本了，如果多邀请几个，比如一个红包最多发50人，就可以赚将近0.005BTC。
另外需要注意，你得确保新人第一次领的以上方法发的红包是你发的，只有第一次才会绑定邀请关系。
如何教会新人完成七次签到赚BTC呢，点击链接登录看这里面之前的帖子：
<https://ohmy.xin/circles/2190180>

### 4.4 只有群主会拿到奖励，并不是红包发起者或者管理员，所以要你来拉群当群主。 
