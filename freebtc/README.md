...
注意，福利还没完，除了上面的红包之外，如果你完成 2.5.1 介绍的签到领 BTC 连续7天，还将获得333聪(0.00000333BTC)的奖励，完成连续14天将再获得333聪。
...
> * 2019年12月21日之前参与签到的有效用户（德成就属于这部分用户），每次领取的BTC会比前一天递增100聪，也就是额外的“加速福利”。
>> - 每天递增的100聪，5年后，将总共领取1.666BTC。前提是完成随机任务，并签到不间断，未完成任务会暂停加速或中断，签到中断会从100聪重新开始。
> * 2019年12月21日之后开始参与签到的用户不需要做任何任务，每天可领取100聪，目前尚不清楚今后会不会再次开放“加速福利”。
> * 2020年8月5日，Lucky BTC Bot 发布消息：有想在这个机器人每天领取 100 聪 BTC 的人请尽快加入，随时会将新加入者的每天领取数量从 100 变成 10，数量改变之前加入的用户不受影响。
>> 改成了10聪依然还是不需要做任何任务。新用户可以找德成领新人红包获得“递增BTC”的分红，后面的第3部分有详细介绍。
...
TaskWall 是Exin团队开发的能让用户做任务（目前主要是答题）瓜分BTC的机器人，Mixin ID 是7000103013，德成的邀请码：2QN3 ，也可以直接[点击这里注册](https://taskwall.mixin.zone/invite/2QN3)，会有额外的份额抽奖机会，完成里面的小任务，就可以瓜分BTC奖池。
...
让你的朋友按照本文介绍的方法领取德成的BTC新人红包(好处之一是，不用你自己花BTC发红包，同时还能获得奖励)，你朋友完成连续7天签到领BTC后，你和你的朋友将分别获得333聪BTC，完成连续14天签到领BTC后，你和你的朋友将再分别获得333聪BTC。

此外，你和你的朋友都可以留在分红群里每天领分红红包，具体怎么分红呢？

重点来了，分红有以下两部分:

* 新人分红：至少10%（目前是18%，随着奖励的累计，越来越丰厚，可能会有所调整，但不会低于10%），以红包形式发到分红群里，由群里所有成员瓜分。(每天发)

* 推荐分红：至少10%（目前是18%，随着奖励的累计，越来越丰厚，可能会有所调整，但不会低于10%），将按照推荐新人人数按比例瓜分，这部分是直接发到个人的。(每周日发)
>> 德成本人邀请的人数不参与瓜分推荐奖励。
