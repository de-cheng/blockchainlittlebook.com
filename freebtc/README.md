...
首先添加德成的微信：cdckql，备注“领BTC红包”，然后在 Mixin messenger 上搜索 37163725，你就可以找到德成，给德成发送消息“领BTC红包”，德成就会拉你到红包群。

你会在这个群里收到红包 —— 很可能是你人生的第一笔免费比特币！
...
TaskWall 也是一个做任务领取BTC的机器人，Mixin ID 是7000103013，填写德成的邀请码：2QN3 ，会有额外的份额抽奖机会，完成里面的小任务，就可以瓜分BTC奖池更大比例。

## 3. 你如何通过邀请朋友获得“加速BTC”的分红

将本页面推送给朋友，让他按照以上方法领取德成的BTC红包后，你邀请的朋友完成连续7天签到领BTC后，你和你的朋友将分别获得5000聪比特币。此外，你和你的朋友都可以留在红包群里，重点来了，这个群会每周发BTC红包，数额就是德成当周签到领取BTC总额的10%。

每周还将按照推荐人数参与瓜分德成签到领取BTC总额的另外10%，也是每周发一次。

请注意，德成本人邀请的人数不参与瓜分这10%，就是说，假如这一周只有你推荐了新人(即使是一个)，假如德成连续加速了一周，目前一周领约30元BTC(以后只会越来越多)，你将额外获得6元的BTC，而且以后会慢慢变多。

请再注意，你不仅可以参与瓜分你推荐新人当周的10%，还可以一直参与之后每周的10%分红。也就是说，如果最终德成成功连续加速1825天，累计领取1.666BTC，将至少拿出20%用于分红。也就是说，如果你一直在德成的群里领分红，将参与分红至少0.333BTC。

### 3.1 跟新人朋友创建群组

把Lucky BTC Bot(7000101487)机器人当做联系人一样也加入群组中。

### 3.2 在群里给新人朋友发红包

点击群组聊天框的加号（+）创建并发送红包, 最少 0.0002 BTC（价值约10元人民币）

> 注意：如果你BTC账号余额减去签到领的BTC总和没有大于0.0002BTC，是不能直接去发红包的，因为那样会导致断签。

那怎么办呢？
买吧，ExinOne是很好用的数字资产定投和交易平台。
>> 其身份认证系统和支付宝用的是一模一样的，放心进行身份认证，认证后才可以顺利购买BTC并签到赚BTC。
如果之前认证过就可以直接买，最少可以买18元左右的BTC，用来发红包足够了。
ExinOne 机器人 ID：7000101276，也可点击链接进入ExinOne：<https://exinone.com/p/ACB4H3>  

（当有效的新人用户抢了你的红包，并完成一次签到赚BTC，新人红包任务就算完成了。）

### 3.3 提醒朋友签到7天

教会新人朋友在 “Lucky BTC Bot”机器人(Mixin ID：7000101487)签到赚BTC，提醒新人朋友连续签到 7 天后，你会收到 0.0001 BTC 的奖励。 

> 所以只要有两个新人连续签到7天，就回本了，如果多邀请几个，比如一个红包最多发50人，就可以赚将近0.005BTC。
另外需要注意，你得确保新人第一次领的以上方法发的红包是你发的，只有第一次才会绑定邀请关系。
如何教会新人完成七次签到赚BTC呢，点击链接登录看这里面之前的帖子：
<https://ohmy.xin/circles/2190180>

注意：只有群主会拿到奖励，并不是红包发起者或者管理员，所以要你来拉群当群主。 
